...
#HOLPATH = "/home/minchao/HOL/bin/hol --maxheap=256"
...
TARGET_THEORIES = ["arithmetic"]#["pred_set"] #["list"] #["rich_list"] # ["integer"] #["arithmetic"] # ["rich_list"] #["pred_set"]
# TARGET_THEORIES = ["ConseqConv", "quantHeuristics", "patternMatches", "ind_type", "while", "one", "sum", "option", "pair", "graph_benchmarks", "normalForms", "relation", "marker", "num", "prim_rec", "arithmetic", "numeral", "basicSize", "numpair", "pred_set", "list", "rich_list", "indexedLists"]
