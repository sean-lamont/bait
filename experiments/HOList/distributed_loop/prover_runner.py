...
from experiments.HOList import deephol_pb2, prover
from experiments.HOList.distributed_loop import options_pb2
from experiments.HOList.utils import build_data
...
class ProofLogToTFExamplesDoFn(beam.DoFn):
    ...
    def __init__(self, tactics_filename: str,
        ...
        self.converter = prooflog_to_examples.create_processor(options=options, theorem_database=theorem_db)
