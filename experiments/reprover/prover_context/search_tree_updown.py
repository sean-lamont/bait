...
class InternalNode(Node):
    ...
    # Set separately by goal_model and up_step
    provable_score = -math.inf
    up_score = -math.inf
    ...
    @out_edges.setter
    def out_edges(self, out_edges) -> Optional[List["Edge"]]:
        # if self.is_explored:
    ...
    # todo could add up_score, total_score or provable_score here?
    @property
