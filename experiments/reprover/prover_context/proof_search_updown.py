...
from experiments.reprover.prover_context.search_tree_updown import *
...
class BestFirstSearchProver:
    ...
    def _step(self):
        ...
        logger.info(f'Search node {search_node.state.id, search_node.goal_num, score, search_node.provable_score, search_node.depth} selected')
