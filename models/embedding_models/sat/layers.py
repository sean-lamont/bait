...
from models.embedding_models.gnn.gnn_layers import get_simple_gnn_layer, EDGE_GNN_TYPES
from models.embedding_models.gnn.digae.digae_model import DigaeSE
