...
class PremiseRetriever(pl.LightningModule):
    ...
    def forward(
        ...
        context_emb = self._encode(state_ids, state_mask)
    ...
    def retrieve(self, state,
                 ctx,  # context/info necessary to retrieve the correct premises
                 k):
    ...
    # Only used for evaluation, todo redo later to be system agnostic
