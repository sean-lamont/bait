...
class SFTDataModule(pl.LightningDataModule):
    ...
    def collate_fn(self, examples) -> Batch:
        ...
        # todo separate response / input, and tactic at the end, verification based on tactic, saving/loading only LoRA weights
        # todo larger lora rank
        batch = {}
        batch["state"] = state
