...
# todo
# - use reinforce loss with KL divergence, as done in below:
# https://github.com/Asap7772/understanding-rlhf/blob/master/llm_experiment/trainers/reinforce_trainer.py#L17
# - (check that the sequence scores from beam search generate are accurate logprobs)
# todo or also check ppo trainer using only step with offline data
# https://huggingface.co/docs/trl/v0.9.3/ppo_trainer
