...
from environments.INT.algos.lib.obs import one_hot, thm2index, index2thm, theorem_no_input, thm_index2no_input, convert_obs_to_dict, \
...
from environments.INT.algos.gnns import FCResBlock
from environments.INT.algos.transformer.modules.models import make_thm_model
