...
from environments.INT.proof_system.utils import EmptyLogicStatement, get_entity_from_ls_and_coding, \
    get_entity_coding_from_ls, is_entity, all_different_subtrees
from environments.INT.data_generation.utils import find_entity_with_name
