...
let PURE_SOS_TAC =
  let tac =
    ...
    CONV_TAC "Examples/sos.ml:(RAND_CONV REAL_RAT_REDUCE_CONV THENC REAL_RAT_LE_CONV)" (RAND_CONV REAL_RAT_REDUCE_CONV THENC REAL_RAT_LE_CONV) in
  REPEAT GEN_TAC THEN REWRITE_TAC[real_ge] THEN
  GEN_REWRITE_TAC "Examples/sos.ml:I" I [GSYM REAL_SUB_LE] THEN
  CONV_TAC "Examples/sos.ml:(RAND_CONV SOS_CONV)" (RAND_CONV SOS_CONV) THEN
