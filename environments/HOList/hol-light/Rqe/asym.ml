...
[
  ...
  STRIP_TAC;
  CONV_TAC "Rqe/asym.ml:(RAND_CONV (ONCE_REWRITE_CONV[REAL_ARITH `&0 = c * &0`]))" (RAND_CONV (ONCE_REWRITE_CONV[REAL_ARITH `&0 = c * &0`]));
...
[
  ...
  ASM_MESON_TAC[LAST];
  STRIP_TAC;
  CONV_TAC "Rqe/asym.ml:(RAND_CONV (ONCE_REWRITE_CONV[REAL_ARITH `&1 = &1 * &1`]))" (RAND_CONV (ONCE_REWRITE_CONV[REAL_ARITH `&1 = &1 * &1`]));
  MATCH_MP_TAC SEQ_MUL;
  CONJ_TAC;
  ASM_SIMP_TAC[DIV_ID];
  MATCH_ACCEPT_TAC SEQ_CONST;
...
[
  ...
  CONV_TAC "Rqe/asym.ml:(LAND_CONV (ONCE_REWRITE_CONV[REAL_ARITH `x = x pow 1`]))" (LAND_CONV (ONCE_REWRITE_CONV[REAL_ARITH `x = x pow 1`]));
...
[
  ...
  REPEAT STRIP_TAC;
  CONV_TAC "Rqe/asym.ml:(LAND_CONV (ONCE_REWRITE_CONV [GSYM REAL_MUL_RID]))" (LAND_CONV (ONCE_REWRITE_CONV [GSYM REAL_MUL_RID]));
  MATCH_MP_TAC REAL_LE_MUL2;
  REPEAT STRIP_TAC;
  REAL_SOLVE_TAC;
  REAL_SIMP_TAC;
...
[
  ...
  CONV_TAC "Rqe/asym.ml:(RAND_CONV (ONCE_REWRITE_CONV[GSYM POLY_NEG_NEG]))" (RAND_CONV (ONCE_REWRITE_CONV[GSYM POLY_NEG_NEG]));
...
[
  ...
  REAL_SIMP_TAC;
  AP_TERM_TAC;
  CONV_TAC "Rqe/asym.ml:(LAND_CONV (ONCE_REWRITE_CONV[GSYM POLY_PNEG_NEG]))" (LAND_CONV (ONCE_REWRITE_CONV[GSYM POLY_PNEG_NEG]));
