...
let countable_prod = prove_by_refinement(
  ...
  (CONV_TAC "Jordan/metric_spaces.ml:(TOP_DEPTH_CONV GEN_BETA_CONV)" (TOP_DEPTH_CONV GEN_BETA_CONV));
  ASM_MESON_TAC[];
  ]);;
...
let min_finite = prove_by_refinement(
  ...
  DISCH_THEN IMATCH_MP_TAC ;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"k\\")" (quant_left_CONV \\"k\\");
  INDUCT_TAC;
...
let real_half_LT = prove_by_refinement(
  ...
  [
  DISCH_ALL_TAC;
  (GEN_REWRITE_TAC "Jordan/metric_spaces.ml:RAND_CONV" RAND_CONV) [GSYM REAL_HALF_DOUBLE];
  UND 0;
  UND 1;
  REAL_ARITH_TAC;
  ]);;
...
let norm_scale_vec = prove_by_refinement(
  ...
  GEN_REWRITE_TAC "Jordan/metric_spaces.ml:(LAND_CONV o RAND_CONV o RAND_CONV o ONCE_DEPTH_CONV)" (LAND_CONV o RAND_CONV o RAND_CONV o ONCE_DEPTH_CONV) [REAL_POW_2];
  ASM_SIMP_TAC[SQRT_MUL;REAL_SUM_SQUARE_POS;REAL_LE_SQUARE_POW;POW_2_SQRT_ABS  ];
  REWRITE_TAC[REAL_POW_2];
    ]);;
...
let open_nbd = prove_by_refinement(
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"B\\")" (quant_left_CONV \\"B\\");
  DISCH_THEN CHOOSE_TAC;
  ...
  DISCH_ALL_TAC;
  NAME_CONFLICT_TAC;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"x'\\")" (quant_left_CONV \\"x'\\");
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"x'\\")" (quant_left_CONV \\"x'\\");
  EXISTS_TAC `x:A`;
...
let open_inters = prove_by_refinement(
  ...
  UND 3;
  UND 4;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"n\\")" (quant_left_CONV \\"n\\");
...
(* {{{ proof *)
 ...
 MESON_TAC[IN];
 REWRITE_TAC[IMAGE];
 GEN_REWRITE_TAC "Jordan/metric_spaces.ml:I" I [EXTENSION];
 X_GEN_TAC `a:A`;
 REWRITE_TAC[IN_UNIONS];
 REWRITE_TAC[IN_ELIM_THM];
 EQ_TAC;
...
(* {{{ proof *)
 ...
 CONV_TAC "Jordan/metric_spaces.ml:(relabel_bound_conv)" (relabel_bound_conv);
...
let complete_euclid = prove_by_refinement(
  ...
  DISCH_TAC;
  GEN_TAC;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_right_CONV \\"n\\")" (quant_right_CONV \\"n\\");
  DISCH_TAC;
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"c\\")" (quant_left_CONV \\"c\\");
...
let totally_bounded_subset = prove_by_refinement(
  ...
  USE 1 (SPEC `eps/(&.2)`);
  CHO 1;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_right_CONV \\"B\\")" (quant_right_CONV \\"B\\");
  DISCH_TAC;
  ...
  GEN_TAC;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"t\\")" (quant_left_CONV \\"t\\");
  MESON_TAC[IN];
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"s\\")" (quant_left_CONV \\"s\\");
  DISCH_THEN CHOOSE_TAC;
  ALL_TAC; (* #set "TB1"; *)
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"x'\\")" (quant_left_CONV \\"x'\\");
  X_GEN_TAC `c:A->bool`;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"u'\\")" (quant_left_CONV \\"u'\\");
  GEN_TAC;
  DISCH_ALL_TAC;
  UND 10;
  ASM_REWRITE_TAC[];
...
let center_FINITE = prove_by_refinement(
  ...
  ALL_TAC; (* #g1; *)
  (ASM (GEN_REWRITE_TAC "Jordan/metric_spaces.ml:LAND_CONV" LAND_CONV)) [];
  ( (GEN_REWRITE_TAC "Jordan/metric_spaces.ml:LAND_CONV" LAND_CONV)) [UNIONS_DELETE];
  AP_TERM_TAC;
  MATCH_MP_TAC EQ_EXT;
  GEN_TAC;
...
let subsequence_rec = prove_by_refinement(
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(quant_right_CONV \\"s'\\")" (quant_right_CONV \\"s'\\");
  SUBCONJ_TAC;
  REWRITE_TAC[INTER_SUBSET];
  DISCH_TAC;
  AND 12;
...
let cauchy_subseq = prove_by_refinement(
  ...
  DISCH_ALL_TAC;
  CONV_TAC "Jordan/metric_spaces.ml:(quant_right_CONV \\"cs'\\")" (quant_right_CONV \\"cs'\\");
  DISCH_TAC;
  AND 11;
...
let countable_dense = prove_by_refinement(
  ...
  ASM_MESON_TAC[];
  CONV_TAC "Jordan/metric_spaces.ml:(quant_left_CONV \\"z\\")" (quant_left_CONV \\"z\\");
  DISCH_THEN CHOOSE_TAC;
...
let countable_cover = prove_by_refinement(
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(RAND_CONV (ONCE_REWRITE_CONV [(GSYM twopow_double)]))" (RAND_CONV (ONCE_REWRITE_CONV [(GSYM twopow_double)]));
...
let compact_uniformly_continuous = prove_by_refinement(
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(quant_right_CONV \\"delta\\")" (quant_right_CONV \\"delta\\");
  DISCH_TAC;
 ...
 ***)
  ...
  CONV_TAC "Jordan/metric_spaces.ml:(RAND_CONV (ONCE_REWRITE_CONV [GSYM REAL_HALF_DOUBLE]))" (RAND_CONV (ONCE_REWRITE_CONV [GSYM REAL_HALF_DOUBLE]));
...
let open_ball_star = prove_by_refinement(
  ...
  GEN_REWRITE_TAC "Jordan/metric_spaces.ml:(LAND_CONV o LAND_CONV)" (LAND_CONV o LAND_CONV) [GSYM trivial_lin_combo];
