...
let SIMP_HORN_TAC =
  ASSUM_LIST (fun xs ->
    ...
    THEN CONV_TAC "Functionspaces/utils.ml:(TOP_DEPTH_CONV (CHANGED_CONV SIMP_HORN_CONV))" (TOP_DEPTH_CONV (CHANGED_CONV SIMP_HORN_CONV))
    THEN REWRITE_TAC xs);;
...
let GCONV_TAC "Functionspaces/utils.ml:" = CONV_TAC "Functionspaces/utils.ml:o" o DEPTH_CONV o CHANGED_CONV;;
