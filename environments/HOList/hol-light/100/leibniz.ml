 ...
 (`summable (\n. (-- &1) pow n / &(2 * n + 1))`,
  ...
  REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
   [REWRITE_TAC[REAL_POW_ADD; REAL_POW_MUL; GSYM REAL_POW_POW] THEN
    CONV_TAC "100/leibniz.ml:REAL_RAT_REDUCE_CONV" REAL_RAT_REDUCE_CONV THEN
...
let SUM_REARRANGE_LEMMA = prove
 (`!a v m n.
  ...
  GEN_REWRITE_TAC "100/leibniz.ml:LAND_CONV" LAND_CONV [REAL_MUL_SYM] THEN
 ...
 (`(\n. (-- &1) pow n / &(2 * n + 1)) sums (pi / &4)`,
  ...
  MP_TAC THENL
   [MATCH_MP_TAC DIFF_CONT THEN EXISTS_TAC
    ...
    REWRITE_TAC[REAL_POW_ONE] THEN CONV_TAC "100/leibniz.ml:REAL_FIELD" REAL_FIELD;
    ALL_TAC] THEN
  ...
  ASSUME_TAC THENL
   [ASM_CASES_TAC `N1 + N2 = 0` THENL
    ...
    CONJ_TAC THENL
     [ALL_TAC;
      GEN_REWRITE_TAC "100/leibniz.ml:RAND_CONV" RAND_CONV [GSYM REAL_MUL_RID] THEN
    ...
    REPEAT STRIP_TAC THENL
     [ASM_SIMP_TAC[REAL_LT_IMP_LE; REAL_POW_LT];
      ...
      GEN_REWRITE_TAC "100/leibniz.ml:LAND_CONV" LAND_CONV [REAL_POW_ADD] THEN
      GEN_REWRITE_TAC "100/leibniz.ml:RAND_CONV" RAND_CONV [GSYM REAL_MUL_RID] THEN
