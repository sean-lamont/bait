...
from environments.int_environment.proof_system.utils import EmptyLogicStatement, get_entity_from_ls_and_coding, \
    get_entity_coding_from_ls, is_entity, all_different_subtrees
from environments.int_environment.data_generation.utils import find_entity_with_name
