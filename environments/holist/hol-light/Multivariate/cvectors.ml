...
let CVECTOR_NON_ZERO = prove
  ...
  GEN_TAC THEN GEN_REWRITE_TAC "Multivariate/cvectors.ml:(RATOR_CONV o ONCE_DEPTH_CONV)" (RATOR_CONV o ONCE_DEPTH_CONV) [CART_EQ]
...
let CVECTOR_ARITH_TAC =
  ...
  GEN_REWRITE_TAC "Multivariate/cvectors.ml:ONCE_DEPTH_CONV" ONCE_DEPTH_CONV [CART_EQ] THEN
...
let CVECTOR_MUL_EQ_0 = prove
  ...
  REPEAT STRIP_TAC THEN EQ_TAC THENL [
    ASM_CASES_TAC `a=Cx(&0)` THENL [
      ASM_REWRITE_TAC[];
      GEN_REWRITE_TAC "Multivariate/cvectors.ml:(RATOR_CONV o DEPTH_CONV)" (RATOR_CONV o DEPTH_CONV) [CART_EQ]
      THEN ASM_REWRITE_TAC[CVECTOR_MUL_COMPONENT;CVECTOR_ZERO_COMPONENT;
        COMPLEX_ENTIRE]
      THEN GEN_REWRITE_TAC "Multivariate/cvectors.ml:(RAND_CONV o DEPTH_CONV)" (RAND_CONV o DEPTH_CONV) [CART_EQ]
...
let CART_EQ3 = prove
  ...
  GEN_REWRITE_TAC "Multivariate/cvectors.ml:(PATH_CONV \\"rbrblr\\")" (PATH_CONV \\"rbrblr\\") [CART_EQ]
...
let CDOT_LREAL = prove
  ...
  THEN GEN_REWRITE_TAC "Multivariate/cvectors.ml:(RATOR_CONV o ONCE_DEPTH_CONV)" (RATOR_CONV o ONCE_DEPTH_CONV) [COMPLEX_EXPAND]
...
let CNORM2_EQ_0 = prove
  ...
  THEN GEN_REWRITE_TAC "Multivariate/cvectors.ml:(RATOR_CONV o DEPTH_CONV)" (RATOR_CONV o DEPTH_CONV) [CART_EQ]
...
let CNORM2_NORM2 = prove
  ...
  GEN_TAC THEN GEN_REWRITE_TAC "Multivariate/cvectors.ml:(RATOR_CONV o ONCE_DEPTH_CONV)" (RATOR_CONV o ONCE_DEPTH_CONV) [GSYM
...
let CORTHOGONAL_REAL_CLAUSES = prove
  ...
  THEN CONV_TAC "Multivariate/cvectors.ml:REAL_FIELD" REAL_FIELD);;
