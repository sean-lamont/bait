 ...
 (SUBGOAL_THEN
  ...
  THENL
   [REWRITE_TAC[LEFT_AND_EXISTS_THM] THEN
    ...
    AP_TERM_TAC THEN GEN_REWRITE_TAC "Arithmetic/derived.ml:I" I [FUN_EQ_THM] THEN
    ...
    ALL_TAC] THEN
  CONV_TAC "Arithmetic/derived.ml:(ONCE_DEPTH_CONV let_CONV)" (ONCE_DEPTH_CONV let_CONV) THEN
