...
let VEC2_TAC =
  ...
  CONV_TAC "Examples/inverse_bug_puzzle_tac.ml:REAL_RING" REAL_RING;;
...
let ORIENTED_AREA_COLLINEAR_CONG = prove
 (`! A B C A' B' C.
  ...
  REWRITE_TAC[COLLINEAR_3_2D; oriented_area] THEN CONV_TAC "Examples/inverse_bug_puzzle_tac.ml:REAL_RING" REAL_RING);;
