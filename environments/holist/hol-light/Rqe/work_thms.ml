...
[
  ...
  POP_ASSUM (fun x -> REWRITE_ASSUMS [x] THEN ASSUME_TAC x);
  REWRITE_TAC[APPEND];
  CONV_TAC "Rqe/work_thms.ml:(LAND_CONV (REWRITE_CONV[partition_line]))" (LAND_CONV (REWRITE_CONV[partition_line]));
  COND_CASES_TAC;
  ...
  CONV_TAC "Rqe/work_thms.ml:(RAND_CONV (LAND_CONV (RAND_CONV (REWRITE_CONV[partition_line]))))" (RAND_CONV (LAND_CONV (RAND_CONV (REWRITE_CONV[partition_line]))));
  ASM_REWRITE_TAC[];
