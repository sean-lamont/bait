...
from data.holist.utils import sexpression_graphs as sexpr, theorem_fingerprint
...
def normalized_fingerprint(theorem: proof_assistant_pb2.Theorem,
    ...
    """Turn theorems into a more unique representation and compute the fingerprint.
