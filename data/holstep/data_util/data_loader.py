...
# mat: Tensor for index add (num_nodes * num_pa001)
...
class DataLoader(object):
    ...
    def directed_generate_one_sentence(self, sentence):
        ...
        for node in sentence:
            ...
            for i, x in enumerate(node.outgoing):
                if node.name in COMM_OP:
                    edge_attr.append(0)
                else:
                    edge_attr.append(i)
        ...
        return (onehot, iindex1, iindex2, imat, oindex1, oindex2, omat, edge_attr)
